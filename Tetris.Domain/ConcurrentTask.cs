...
namespace BlockArena.Domain
{
    public class ConcurrentTask
    {
        ...
        private static async Task<List<IndexedResult<T>>> RunInSeries<T>(IEnumerator<IndexedTaskProvider<T>> enumerator, List<IndexedResult<T>> accumalatedValues = null)
        {
